...
// Validar parámetro
if (!isset($_GET['codigo_informe'])) {
    jsonResponse(['error' => 'Parámetro "código de informe" requerido'], 400);
}

$codigo_informe = $_GET['codigo_informe'];


// Consulta con filtro por código de informe
$sql = <<<SQL
WITH base AS (
...
try {
    ...
    $stmt->execute(['codigo_informe' => $codigo_informe]);
